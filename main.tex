...
\begin{frame}{What could we expect}
    \begin{center}
        ...
        \raisebox{-0.5\height}{\includegraphics[width=0.3\textwidth]{figs/julia-logo-300.png}}\qquad
        \raisebox{-0.5\height}{\includegraphics[width=0.25\textwidth]{figs/atom_ed.png}}
    \end{center}
\end{frame}
